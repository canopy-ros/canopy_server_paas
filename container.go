...
// Container is a container for a MongoDB session
...
// Process is the metadata for a process
type Process struct {
...
// TemplateStruct is a template structure
...
func (c *Container) start() {
	...
	err := c.h.cli.ContainerStart(context.Background(), c.id, startOptions)
	if err != nil {
		return
	}
	c.started = true
